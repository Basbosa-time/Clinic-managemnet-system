  ...
  .post(
    ...
    [
      ...
      body("gender")
        ...
        .notEmpty()
        .isIn(["male", "female"])
        .withMessage("gender should be a string whether male or female"),
    ],
...
router
  .get(
    ...
    [
      query("patientId")
        .isAlphanumeric()
        .withMessage("patientId should be alphanumeric"),
      param("patientId")
        .notEmpty()
        .isAlphanumeric()
        .withMessage("send patient id as alphanumeric to get his data"),
    ],
  ...
  .put(
    ...
    [
      ...
      body("name")
        .isString()
        .withMessage("name shoudl be string")
        .not()
        .isEmpty()
        .trim()
        .escape(),
